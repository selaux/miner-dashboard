...
module.exports = Module.extend({
    ...
    set: function () {
        var self = this,
            ...
            sourceElement = { timestamp: now, avgHashrate: attributes.avgHashrate },
        ...
        if (lastUnfilledDataElement) {
            ...
            if (historicalData.length > 1) {
                fullElement.source.push({ timestamp: now, avgHashrate: historicalData[historicalData.length-2].avgHashrate });
            }
    ...
    buildMeanValue: function (historicalData) {
        ...
        lastDataElement.avgHashrate = _(lastDataElement.source).pluck('avgHashrate').reduce(sum) / lastDataElement.source.length;
